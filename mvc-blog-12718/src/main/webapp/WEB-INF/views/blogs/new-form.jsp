      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="page-heading">
          	<h2>Write a Blog</h2>
            <h3 class="subheading">
            <span class="meta">블로그에 글을 남기십시요</span>
            </h3>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <form action="../blogs" method="post" enctype="multipart/form-data" 
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Blogger</label>
              <input type="text" value="${blogger.bid}"class="form-control" name="blogger" placeholder="Blogger" id="name" required data-validation-required-message="Please enter your name.">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <br>
